...
NDefines.NMilitary.BASE_LEADER_TRAIT_GAIN_XP = 0.05	-- vilkata defines
NDefines.NMilitary.FIELD_MARSHAL_XP_RATIO = 0.05 	-- vilkata defines
NDefines.NMilitary.LEADER_EXPERIENCE_SCALE = 0.2 	-- vilkata defines
NDefines.NMilitary.XP_GAIN_PER_OVERRUN_UNIT = 15	-- vilkata defines
NDefines.NMilitary.XP_GAIN_FOR_SHATTERING = 15 	-- vilkata defines
