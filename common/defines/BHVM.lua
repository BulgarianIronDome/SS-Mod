...
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_UNITS_STACK = 1 
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_UNITS_STACK_GROUP = 10
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_VICTORY_POINTS = 5
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_RESOURCE = 10
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_CONSTRUCTION_INFO = 3
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_CONSTRUCTION_INFO = 3
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_AIR_BASE = 3
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_ROCKET_SITE = 3
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_NAVAL_BASE = 15
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_NAVAL_COMBAT = 15
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_NAVAL_COMBAT_RESULTS = 14
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_LAND_COMBAT = 20
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_NAVAL_MISSION = 20
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_AIR_MISSION = 13
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_SUPPLY = 14
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_CAPITAL = 5
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_PEACE_COST = 3
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_ADJACENCY_RULE = 3
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_NAVAL_MINES = 13
NDefines_Graphics.NMapMode.STRATEGIC_NAVY_PRIORITY_NAVAL_ACCIDENTS = 13
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_UNITS_STACK = 7
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_UNITS_STACK_GROUP = 8
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_VICTORY_POINTS = 5
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_RESOURCE = 10
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_CONSTRUCTION_INFO = 3
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_AIR_BASE = 3
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_ROCKET_SITE = 3
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_NAVAL_BASE = 2
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_NAVAL_COMBAT = 15
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_NAVAL_COMBAT_RESULTS = 14
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_LAND_COMBAT = 20
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_NAVAL_MISSION = 13
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_AIR_MISSION = 13
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_SUPPLY = 14
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_CAPITAL = 5
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_PEACE_COST = 3
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_ADJACENCY_RULE = 3
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_NAVAL_MINES = 13
NDefines_Graphics.NMapMode.DEPLOYMENT_NAVY_PRIORITY_NAVAL_ACCIDENTS = 13
NDefines_Graphics.NMapMode.MAX_DISPLAYED_TASK_FORCES = 24


NDefines_Graphics.NGraphics.MINIMAP_PING_DELAY_BETWEEN_PINGS = 0.3
NDefines_Graphics.NGraphics.MINIMAP_PING_DURATION = 16